...
let data = [
  ...
  {
    id: 'SingaFlower3',
    url: 'https://i.imgur.com/67r0FdB.jpg',
  ...
  {
    id: 'SingaFlower4',
    url: 'https://i.imgur.com/SVDaEjI.jpg',
  ...
  {
    id: 'SingaFlower5',
    url: 'https://i.imgur.com/bahJfL9.jpg',
...
const ProjectsGallery = (props) => {
  return (
    <ViewContainer className={styles.projectsView}>
      <Grid className={styles.grid} contents={data.concat(data).concat(data)} />
    </ViewContainer>
  );
};
